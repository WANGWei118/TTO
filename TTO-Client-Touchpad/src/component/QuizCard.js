...
const QuizCard = (props) => {
    ...
    const defaultImage = () => {
        if (topic === 'animal') {
            return (
                <img className="quizImage" alt="Quiz sur le theme des Animaux" src={"http://192.168.1.16:10000/assets/animals.jpg"} />)
        }
        else {
            return (<img className="quizImage" alt="Quiz sur le theme des Fruits" src={"http://192.168.1.16:10000/assets/Fruits.jpg"} />)
        }
    }
