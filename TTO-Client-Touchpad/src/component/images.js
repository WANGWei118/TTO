...
const bananes = require('./../assets/bananes.png');
const basket = require('./../assets/basket.jpg');
const bean = require('./../assets/bean.jpeg');
...
const images = [
    ...
    { id: 2, src: './../assets/bananes.png', title: bananes, description: 'bar' },
    { id: 3, src: './../assets/basket.jpg', title: basket, description: 'bar' },
    { id: 4, src: './../assets/bean.jpeg', title: bean, description: 'bar' },
